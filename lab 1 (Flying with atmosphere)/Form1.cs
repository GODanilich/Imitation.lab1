    ...
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (!timer.Enabled)
            {
                ...
                MaxYOutput.Text = maxY.ToString();
                Distance.Text = maxX.ToString();
                EndSpeed.Text = Math.Sqrt(Math.Pow(points[points.Count - 1].X - points[points.Count - 2].X, 2) + Math.Pow(points[points.Count - 1].Y - points[points.Count - 2].Y,2)).ToString();
